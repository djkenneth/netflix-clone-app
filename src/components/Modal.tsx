...
// Icons
import { HiX, HiCheck, HiPlus, HiOutlineThumbUp, HiOutlineVolumeOff, HiOutlineVolumeUp } from 'react-icons/hi'
  ...
  return (
    <MuiModal open={showModal} onClose={handleClose} className='fixed !top-7 left-0 right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll rounded-md scrollbar-hide'>
        <>
            ...
            <button onClick={handleClose} className='modal-button absolute right-5 top-5 !z-40 h-8 w-9 border-none bg-[#181818] hover:bg-[#181818]'>
